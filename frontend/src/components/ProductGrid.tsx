        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-16 border-b border-white/10 pb-6 gap-6">
          ...
          <div className="relative w-full md:w-64">
            <input
              ...
              className="w-full bg-[#111] border border-white/10 px-4 py-2 pl-10 text-sm text-white focus:outline-none focus:border-[var(--accent)] transition-colors rounded-full placeholder-gray-600"
        ...
        {totalPages > 1 && (
          <div className="flex justify-center items-center space-x-2">
            <button
              ...
              className="w-10 h-10 border border-white/10 flex items-center justify-center text-white hover:border-[var(--accent)] hover:text-[var(--accent)] disabled:opacity-30 disabled:hover:border-white/10 disabled:hover:text-white transition-colors"
            >
              <ChevronLeft size={16} />
            </button>
              ...
              <button
                ...
                className={`w-10 h-10 border flex items-center justify-center text-sm font-bold transition-colors ${
                  currentPage === i + 1
                    ...
                    : "border-white/10 text-white hover:border-[var(--accent)] hover:text-[var(--accent)]"
                }`}
              >
                {i + 1}
              </button>
