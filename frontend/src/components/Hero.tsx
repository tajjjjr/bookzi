...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center pt-20 pb-20 md:pb-0 overflow-hidden bg-[var(--background)]">
      {/* Background Ambience */}
      ...
      <div className="max-w-7xl mx-auto px-6 w-full h-full flex flex-col md:flex-row items-center relative z-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center pr-0 md:pr-12 mb-12 md:mb-0">
          <div className="inline-flex items-center space-x-2 border border-[var(--accent)]/30 rounded-full px-3 py-1 w-fit mb-8">
        ...
        <div className="w-full md:w-1/2 relative h-[400px] md:h-[600px] flex items-center justify-center">
          ...
          <div className="relative w-full h-full bg-[#111] border border-white/5 overflow-hidden group rounded-3xl">
            <img
              src={slide.image}
              alt={slide.headline}
          ...
          <div className="absolute -bottom-6 right-0 flex space-x-4 z-30">
            <button
              ...
              className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white hover:border-[var(--accent)] hover:text-[var(--accent)] transition-all bg-[var(--background)]"
            >
              <ArrowLeft size={18} />
            </button>
            <button
          ...
          {/* Slide indicators */}
          <div className="absolute -bottom-6 left-5 flex space-x-2 items-center h-12 z-30">
